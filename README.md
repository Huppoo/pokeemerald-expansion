# About this Feature Branch:
This feature branch adds Vols Custom Start Menu to pokeemerald-expansion. It also option_menu page 2 and adds  ability to swap between 4 different palettes. 

It currently is configured for 4 pals, but you can expand it to 8 or even 16 if you have the save space available for it. You can also edit the bg.pal to change the pattern, and even add more colors if you'd like.

![gif showing swapping the menu pal using the options menu](Phantonomy_vol_start_menu_pal_swticher.webp)
